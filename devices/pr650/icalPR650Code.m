function cmdStr =  icalPR650Code(prCMD)
% Translate a photoresearch command into the pr650 code 
% 
% (based on the manual)
%
% See also
...
switch prCMD
    ...
    case 'aperturetiny'
        ...
        % 0.25 deg
        warning('Not working on our PR 650');
        cmdStr = ['SF2',char(13)];
    case 'aperturesmall'
        % 0.5 deg
        cmdStr = ['SF1',char(13)];
    ...
    case {'measurecie'}
        ...
        % icalPR650write(pr,icalPR650Code('measure cie'));
        % val = pr.readline;
        cmdStr = ['M12',char(13)];
