function [ R,G,B,ariRGB,ariRaw  ] = importASAri( fileName )
% importASAri. Read an ARI file from the ARRISCOPE and output an RGB RAW
% Image
%   RGB = importASAri(FILENAME) reads the ARI file specified by the string
%   FILENAME.
